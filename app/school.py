                ...
                while (choice !=0):
                    ...
                    match choice:
                        ...
                        case 1:  # student admission
                            ...
                            currentIdCount = super().getRegistrar().get_students_list()[len(super().getRegistrar().get_students_list())-1].getId() if len(super().getRegistrar().get_students_list())>0 else 0
                            logged: Person() = None
                            fn = input("Enter student's first name: ")
                            ln = input("Enter student's last name: ")
                            age = int(input("Enter student's age: "))
                            studType = int(input("Enter student's type [1] Elementary, [2] High School, [3] College: \n"))
